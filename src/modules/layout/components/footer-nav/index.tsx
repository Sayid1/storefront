...
const FooterNav = () => {
  ...
  return (
    <Fragment>
      <h2 id="footer-heading" className="t">Footer</h2>
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 pt:32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold leading-6 text-white">Solutions</h3>
                <ul role="list" className="mt-6 abw">
          ...
          <div className="mt-10 xl:mt-0">
            ...
            <form className="mt-6 sm:flex sm:max-w-md">
              <label htmlFor="email-address" className="t">Email address</label>
              <Input
                radius="sm"
                type="email"
                autoComplete="email"
              ...
              <div className="mt-4 sm:ml-4 sm:mt-0 sm:shrink-0">
                <button type="submit" className="flex w-full items-center justify-center rounded-md bg-indigo-500 px-3 py-2.5 text-sm font-semibold text-white bbn biq boy boz bpb bpj">Subscribe</button>
              </div>
            </form>
          </div>
        </div>
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
          <div className="flex abl md:order-2">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">© 2020 Your Company, Inc. All rights reserved.</p>
        </div>
      </div>
    </Fragment>
  )
