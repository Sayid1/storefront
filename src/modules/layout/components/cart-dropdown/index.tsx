  ...
  return (
    <div className="h-full z-50" onMouseEnter={open} onMouseLeave={close}>
      <Popover className="relative h-full">
        <Popover.Button className="h-full px-2 py-1 block relative" as="a" href="/cart">
            <ShoppingCartIcon className="w-6 h-6" />
            <span className="absolute right-[2%] top-[5%] text-xs flex items-center justify-center w-[18px] h-[18px] bg-[#ffd700] text-black rounded-full">{totalItems}</span>
        </Popover.Button>
        <Transition
          show={state}
          as={Fragment}
